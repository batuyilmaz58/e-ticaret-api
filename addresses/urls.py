...
urlpatterns = [
    ...
    path('admin', AdminAddressListCreateView.as_view(), name="admin_address_list_create_view"),
    path('admin/<int:address_id>', AdminAddressRetrieveUpdateDeleteView.as_view(), name="admin_address_details_view"),
]